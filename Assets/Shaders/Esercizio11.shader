Shader "Unlit/Esercizio11"
{
    /*Questa shader genera un effetto ondulato grazie all'utilizzo di una noise Simplex 3D.
    Invece di utilizzare triangoli per le celle della simplex genera degli ottaedri, in questo modo
    si ottiene un effetto ondulato che altrimenti sarebbe complesso da ricreare.
        ...
        Pass
        {
            HLSLPROGRAM
                ...
                float4 frag(v2f v) : SV_Target
                {
                    ...
                    float3 pos = float3(uv*250., _Time.y);
